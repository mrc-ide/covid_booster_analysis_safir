...
run_scenario <- 
  function(fit,
    ...
    rt_out <- readRDS(paste0("data/", rt_out_filename, ".rds"))
    
    # read in external pulse
    lambda_external <- readRDS(paste0("data/", lambda_external_filename, ".rds"))
    ...
    vaccine_out <- get_vaccine_strategy(strategy, days_to_vacc_start = days_to_vacc_start, doses_per_day = doses_per_day, 
                                        time_period = time_period, max_coverage = max_coverage, age_groups_covered = age_groups_covered, 
                                        age_groups_covered_d3 = age_groups_covered_d3, age_groups_covered_d4 = age_groups_covered_d4,
                                        age_groups_covered_d5 = age_groups_covered_d5, age_groups_covered_d6 = age_groups_covered_d6,                                        
                                        age_groups_covered_d7 = age_groups_covered_d7, age_groups_covered_d8 = age_groups_covered_d8,                                         
                                        age_groups_covered_d9 = age_groups_covered_d9, vaccine_doses = vaccine_doses, pop = pop, vacc_per_week = vacc_per_week, 
                                        t_d3 = t_d3, t_d4 = t_d4, t_d5 = t_d5,t_d6 = t_d6, t_d7 = t_d7, t_d8 = t_d8, t_d9 = t_d9,t_10y_start = t_10y_start)
    ...
    # new code for making mu_ab_infection as a vector - just need to change the parameters function below to turn this on
    # on reflection it could just be vfr_vector*mu_ab_infection...but leave like this to be flexible
    ...
    parameters <-
      make_immune_parameters(
        ...
        vfr = vfr_vector,
        mu_ab_infection = mu_ab_infection_vector,
    ...
    dr_vec_inf <- dr_vec %>%
      select(-t,-D1,-D2,-D3, -D4, -D5, -D6, -D7, -D8, -D9) 

...
rt_out <- data.frame(Rt = rt_base_out$Rt * rt_omicron_mult$Rt, Rt_tt = rt_base_out$Rt_tt)

saveRDS(rt_out, "data/rt_out_lmic.rds")
...
saveRDS(lambda_external, "data/lambda_external_lmic.rds")
